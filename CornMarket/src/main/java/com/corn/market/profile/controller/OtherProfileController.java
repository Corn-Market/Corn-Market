...
public class OtherProfileController {
	...
	public String otherProfileOnSale(@PathVariable String user_id, Model model) throws Exception {
	...
	public String otherProfileOffSale(@PathVariable String user_id, Model model) throws Exception {
	...
	public String otherProfileReview(@PathVariable String user_id, Model model) throws Exception {
