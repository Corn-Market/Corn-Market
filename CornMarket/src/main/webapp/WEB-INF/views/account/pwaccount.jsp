    ...
    <div class="search-wrap">
      ...
      <div class="id-search-wrap">
        <div class="id-search-notice">
          <span>본인확인 후 비밀번호를 다시 설정할 수 있습니다. </span>
        </div>
        <div class="search-type">
          <ul>
            <li class="type-list-current">
              <div class="search-title">
                <button type="button" id="search-display" onclick="searchdisplayemail()" class="arrow-dropdown-hp">
                  등록된 이메일로 찾기
                </button>
              </div>
                  ...
                  <form action="<c:url value='/account/pw'/>" method="POST" name="frmPw">
                    <div class="inputBox">
                      <div class="styleInput">
                        <input id="conInput" name="user_id" type="text" class="input1" placeholder="아이디" />
                      ...
                      <div class="emailInput">
                        <div class="styleInput">
                          <input name="email_id" id="memberEmail" type="text" class="inputE" placeholder="이메일" />
                          <span id="conClear" class="delBtn" style="display: none"></span>
                        </div>
                      ...
                      <div class="codenumInput" id="code-show-input">
                        <input id="codeNum" class="inputC" type="text" placeholder="인증번호 네자리를 입력해주세요" />
