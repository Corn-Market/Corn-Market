  ...
  <body>
    ...
    <section class="board-lookup-wrap">
          ...
          <ul id="pageInfo" class="pageInfo">
            ...
            <c:if test="${pageMaker.prev}">
              <li class="pageInfo_btn previous">
                <a href="${path}/post/category?id=${list[0].category_id}&PageNum=${pageMaker.startPage-1}">
                  <img class="post_btn" src="${path }/resources/images/post/prev.png" width="28px" height="28px" />
                </a>
              </li>
            </c:if>
            ...
            <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
              <li class="pageInfo_btn">
                <a href="${path}/post/category?id=${list[0].category_id}&PageNum=${num}" id="clickPage${num}">${num}</a>
              </li>
            </c:forEach>
            ...
            <c:if test="${pageMaker.next}">
              <li class="pageInfo_btn next">
                <a href="${path}/post/category?id=${list[0].category_id}&PageNum=${pageMaker.endPage + 1}">
                  <img class="post_btn" src="${path }/resources/images/post/next.png" width="28px" height="28px" />
                </a>
              </li>
            </c:if>
          </ul>
      ...
      <form id="moveForm" action="get">
        <input type="hidden" name="pageNum" id="loadPage" value="${pageMaker.cri.pageNum}" />
